...
function Library:Notification(Option) 
    ...
    getgenv().ThemeNotification = Color3.fromRGB(120,0,200)
...
function Library:Window(newName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
    ...
    header.Name = "header"
    header.Parent = Main
    header.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
    header.BorderSizePixel = 0
    header.ClipsDescendants = true
    header.Size = UDim2.new(1.00000012, 0, -0.00295740133, 36)

    Library:DraggingEnabled(header, shadow) 
    ...
    triangle1.ImageColor3 = Color3.fromRGB(120, 0, 200)
    ...
    triangle.ImageColor3 = Color3.fromRGB(120, 0, 200)
    ...
    function Sections:Tab(title)
        ...
        local ListOfFunction = {}

        function ListOfFunction:Button(title, callback)
            ...
            btnFrame.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
            ...
            Sample.ImageColor3 = Color3.fromRGB(120, 0, 210)
            ...
            btn.MouseEnter:Connect(function()
                game.TweenService:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
                    BackgroundColor3 = Color3.fromRGB(120, 0, 210)
                }):Play()
            end)
            btn.MouseLeave:Connect(function()
                game.TweenService:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
        ...
        function ListOfFunction:CheckBox(title, callback)
            ...
            toggleFrame.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
        ...
        function ListOfFunction:TextBox(title, callback)
            local BoxFunctions = {}
            title = title or ""
            callback = callback or function() end
            ...
            textboxFrame.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
            ...
            txtbox.BackgroundColor3 = Color3.fromRGB(27, 27, 27)
            txtbox.BorderColor3 = Color3.fromRGB(27, 27, 27)
        ...
        function ListOfFunction:Slider(title, minvalue, maxvalue, callback)
            title = title or ""
            ...
            sliderFrame.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
            ...
            SliderButton.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
        ...
        function ListOfFunction:KeyBind(title, currentKey, callback)
            title = title or ""
            ...
            keybindFrame.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
        ...
        function ListOfFunction:List(title, list, callback)
            local DropdownFunc = {}
            title = title or "nil"
            list = list or {}
            callback = callback or function() end
            ...
            dropFrame.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
            ...
            dropOpen.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
            ...
            for i,v in next, list do
                ...
                dropOption.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
                ...
                Sample_2.ImageColor3 = Color3.fromRGB(120, 0, 210)
        ...
        function ListOfFunction:Line()
            local seperator = Instance.new("Frame")

            seperator.Name = "seperator"
            seperator.Parent = sectionMain
            seperator.BackgroundColor3 = Color3.fromRGB(120, 0, 200)
